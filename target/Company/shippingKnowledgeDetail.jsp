        ...
        <div  style="float:left;width: 18%;height:300px">
            <ul style="list-style-type: none;padding: 0px;margin: 0px">
                ...
                <li id="a" class="LongGuanLinHunzi" onclick="aa()" style="height: 35px;width: 100%;border-bottom: 1px dashed gray;width:100%;font-size: 14px;position: relative;cursor: pointer">
                    <a href="${pageContext.request.contextPath}/ShippingKnowledgeServlet"><b id="a1" style="margin-left: 10px;position: absolute;margin-top: 7px;width: 100%;display: block;FONT-FAMILY: Arial, Helvetica, sans-serif">行业动态</b></a>
                </li>
